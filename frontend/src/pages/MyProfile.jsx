...
const MyProfile = () => {
  ...
  //   name: "Jatin Kumar soni",
  //   image: assets.profile_pic,
  //   email: 'jatin09soni@gmail.com',
  //   phone: "+918877143049",
  //   address: {
  //     line1: "litchi bagan ratu",
  //     line2: "Ranchi,835222"
  //   },
  //   gender: 'male',
  //   dob: '16-08-2002'
    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      {
        ...
        ? <label htmlFor='image'>
          <div className='inline-block relative cursor-pointer'>
            ...
            <img className='w-10 absolute bott0m-12 right' src={image ? '':assets.upload_icon } alt='' />
          </div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          </p>
          {
           ...
           <div className='flex flex-col gap-2'>
              ...
              }))} value={userData.address.line1} type="text" /><br></br>


            <input className='bg-gray-50' onChange={(e) => setUserData(prev => ({ ...prev, address: { ...prev.address, line2: e.target.value } 
            }))}  value={userData.address.line2} type="text" /></div> 

            : <p className='text-gray-500'>{userData.address.line1}<br></br>{userData.address.line2}</p>
          }
        </div>
      </div>
      <div>
      ...
      <div className='mt-10'>
        {
          isEdit ? <button className='border border-blue-400 px-8 py-2 rounded-full hover:bg-blue-400 hover:text-white transition-all' onClick={updateUserProfileData}> Save Information </button>
          : <button  className='border border-blue-500 px-8 py-2 rounded-full hover:bg-blue-400 hover:text-white transition-all' onClick={()=>setIsEdit(true)}>Edit</button>
          }
      </div>
    </div>
  )
